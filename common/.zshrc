...
# export FZF_CTRL_R_COMMAND="$FZF_DEFAULT_COMMAND"  # not supported yet
export FZF_CTRL_R_OPTS="--preview 'echo {}' --preview-window=up:3:wrap --bind 'ctrl-y:execute-silent(echo -n {2..} | xclip -selection clipboard)+abort' --header 'Press CTRL-Y to copy to clipboard'"
